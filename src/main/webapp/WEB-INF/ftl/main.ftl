...
<div id="layout" class="content pure-g">
        ...
        <div class="nav-inner">
            ...
            <div class="pure-menu pure-menu-open">
                <ul>
                	<br>
                	<br>
                    <li><a href="#"><span class="email-label-personal"></span>Personal&nbsp;<span class="email-count">(2)</span></a></li>
                    <li><a href="#"><span class="email-label-work"></span>Family&nbsp;<span class="email-count">(8)</span></a></li>
                    <li><a href="#"><span class="email-label-friends"></span>Friends&nbsp;<span class="email-count">(12)</span></a></li>
                    <li><a href="#"><span class="email-label-travel"></span>Public&nbsp;<span class="email-count">(25)</span></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="list" class="pure-u-1">
        ...
        <div class="email-item email-item-unread pure-g">
            ...
            <div class="pure-u">
               ...
               <span class="email-desc"><span class="email-name">RAGHUMAN BABU JAYARAMAN</span> transferred <font color=#01A9DB>10 EUR</font> on <font color="#01A9DB">11/Nov/2014 2.29 AM GMT+1.00</font> to <span class="email-name">RAMYA DHARUMAN</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                ...
                <br><button class="comment-button">comment</button>&nbsp;&nbsp;<button class="comment-button">pay1</button>&nbsp;&nbsp;<button class="comment-button">pay2</button>
        	</div>
        ...
        <div class="email-item email-item-unread pure-g">
        	...
        	<div class="pure-u">
                <img class="email-avatar2" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/tilo-avatar.png">
               <span class="email-desc"><span class="email-name">SJAAK HOJENBOS</span> transferred <font color=#01A9DB>10 EUR</font> on <font color="#01A9DB">11/Nov/2014 2.29 AM GMT+1.00</font> to <span class="email-name">EROL MEHMED SHABAN</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <img class="picture-bottom" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/ericf-avatar.png">
                <br><button class="comment-button">comment</button>&nbsp;&nbsp;<button class="comment-button">pay1</button>&nbsp;&nbsp;<button class="comment-button">pay2</button>
        	</div>
        ...
        <div class="email-item email-item-unread pure-g">
        	...
        	<div class="pure-u">
                <img class="email-avatar2" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/tilo-avatar.png">
               <span class="email-desc"><span class="email-name">FRANS NIEWEHEN</span> transferred <font color=#01A9DB>10 EUR</font> on <font color="#01A9DB">11/Nov/2014 2.29 AM GMT+1.00</font> to <span class="email-name">JAN DE BOER</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <img class="picture-bottom" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/ericf-avatar.png">
                <br><button class="comment-button">comment</button>&nbsp;&nbsp;<button class="comment-button">pay1</button>&nbsp;&nbsp;<button class="comment-button">pay2</button>
        	</div>
        ...
        <div class="email-item email-item-unread pure-g">
        	...
        	<div class="pure-u">
                <img class="email-avatar2" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/tilo-avatar.png">
               <span class="email-desc"><span class="email-name">RICK BRANDS</span> transferred <font color=#01A9DB>10 EUR</font> on <font color="#01A9DB">11/Nov/2014 2.29 AM GMT+1.00</font> to <span class="email-name">LOUISA NEWNES</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <img class="picture-bottom" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/ericf-avatar.png">
                <br><button class="comment-button">comment</button>&nbsp;&nbsp;<button class="comment-button">pay1</button>&nbsp;&nbsp;<button class="comment-button">pay2</button>
        	</div>
    ...
    <div id="main" class="pure-u-1">
        ...
        <h4 class="email-title2">FAMILY</h4>
        <input type="text" size="30" />
        <button class="primary-button pure-button">Search & Connect</button>
        </div>
           ...
           <div class="email-content-header pure-g">
            ...
            <div class="email-content-body">
                ...
                <div class="pure-u-3-4">
	                ...
	                <span class="email-subject">Payment Account, ING Bank</span>
	            </div>
            	<br>
            	<br>
            	<div class="pure-u">
	            ...
	            <div class="pure-u-3-4">
	                <h5 class="email-name2">JAN DE BOER</h5>
	                <span class="email-subject">Payment Account, ABN Amro Bank</span>
	            </div>
	            <br>
            	<br>
            	<div class="pure-u">
	                <img class="email-avatar" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/andrew-avatar.png">
	            </div>
	            <div class="pure-u-3-4">
	                <h5 class="email-name2">SJAAK HOEJENBOS</h5>
	                <span class="email-subject">Payment Account, Rabobank</span>
	            </div>
	            <br>
            	<br>
            	<div class="pure-u">
	                <img class="email-avatar" alt="Tilo Mitra&#x27;s avatar" height="64" width="64" src="static/images/ericf-avatar.png">
	            </div>
	            <div class="pure-u-3-4">
	                <h5 class="email-name2">RAGHUMAN BABU JAYARAMAN</h5>
	                <span class="email-subject">Payment Account, ABN Amro Bank</span>
	            </div>
