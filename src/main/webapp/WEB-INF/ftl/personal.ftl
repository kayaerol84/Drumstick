...
<div id="layout" class="content pure-g">
        ...
        <div class="nav-inner">
            ...
            <div class="pure-menu pure-menu-open">
                <ul>
                	<br>
                	<br>
                    <li><a href="http://localhost:8080/drumstick/loadPersonalFinal" id="a1"><span class="email-label-personal"></span><b><font color=#01DF3A size="5">Personal</font></b>&nbsp;<span class="email-count">(48)</span></a></li>
                    <li><a href="http://localhost:8080/drumstick/loadFamilyFinal" id="a2"><span class="email-label-work"></span>Family&nbsp;<span class="email-count">(78)</span></a></li>
                    <li><a href="http://localhost:8080/drumstick/loadFriendsFinal" id="a3"><span class="email-label-friends"></span>Friends&nbsp;<span class="email-count">(55)</span></a></li>
                    <li><a href="http://localhost:8080/drumstick/loadPublicFinal" id="a4"><span class="email-label-travel"></span>Public&nbsp;<span class="email-count">(50)</span></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="email-item email-item-unread pure-g">
            ...
            <div class="pure-u">
               ...
               <span class="email-desc"><span class="email-name">RAGHUMAN BABU JAYARAMAN</span> transferred <font color=#01A9DB>10 EUR</font> on <font color="#01A9DB">11/Nov/2014 2.29 AM GMT+1.00</font> to <span class="email-name">RAMYA DHARUMAN</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                ...
                <br><button class="comment-button" onclick="showComment()">comment</button>&nbsp;&nbsp;<button class="comment-button">like</button>&nbsp;&nbsp;<button class="comment-button">pay</button>
                <br><span id="commentBox" style="display:none"><textarea rows="1" cols="80"></textarea><button type="button" onclick="closeComment()">post</button><button id="cancelbutton" type="button" onclick="closeComment()">cancel</button></span>
        	</div>
    ...
    <div id="main" class="pure-u-1">
        ...
        <h4 class="email-title2">PERSONAL</h4>
           ...
           <div class="email-content-header pure-g">
            ...
            <div class="email-content-body">
                ...
                <div class="pure-u-3-4">
	                ...
	                <span class="email-subject">NL11INGB0005226381</span>&nbsp;&nbsp;<span class="email-subject">ING Bank Spain</span>
