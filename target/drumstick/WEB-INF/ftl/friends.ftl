...
<div id="layout" class="content pure-g">
        ...
        <div class="nav-inner">
            ...
            <div class="pure-menu pure-menu-open">
                <ul>
                    ...
                    <li><a href="http://localhost:8080/drumstick/loadFriendsFinal" id="a3"><span class="email-label-friends"></span><b><font color=#01DF3A size="5">Friends</font></b>&nbsp;<span class="email-count">(12)</span></a></li>
                    <li><a href="http://localhost:8080/drumstick/loadPublicFinal" id="a4"><span class="email-label-travel"></span>Public&nbsp;<span class="email-count">(25)</span></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="main" class="pure-u-1">
        ...
        <h4 class="email-title2">FRIENDS</h4>
